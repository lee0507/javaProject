...
public class ExchangeMoney3 {//클래스 선언
	...
	public static void main(String[] args) {//메인으로부터 프로그램시작
		...
		k30_usd = (int)(k30_MyWon / (k30_MoneyEx + k30_ComPerOne));//k30_usd 변수에 숫자형으로 형변환한 (int)(k30_MyWon / (k30_MoneyEx + k30_ComPerOne)) 값을 저장한다.
		k30_totalcom = k30_usd * k30_ComPerOne;//k30_usd 변수에 k30_usd * k30_ComPerOne 값을 저장한다.
		...
		k30_remain = (int)(k30_MyWon - k30_usd * k30_MoneyEx - k30_i_totalcom);// 변수 k30_remain에 숫자형으로 형변환한 k30_MyWon - k30_usd * k30_MoneyEx - k30_i_totalcom를 저장한다.

...
public class P10classScoreArrayList {
	
	static ArrayList <P10OneRec> k30_ArrayOneRec = new ArrayList <P10OneRec>();//클래스의 ArrayLlist k30_ArrayOneRec을 생성한다.
	...
	private static void ItemPrint(int k30_i) {//ItemPring함수를 생성하고 파라미터로 숫자형 변수 k30_i를 주었다..
		// TODO Auto-generated method stub
		P10OneRec k30_rec;//P9OneRec 클래스를 받아서 객체를 만든다.
	...
	private static void dataSet() {//dataSetPrint함수를 생성한다.
		...
		for (int k30_i = 0; k30_i < k30_iPerson; k30_i++) {//for반복문으로 k30_i가 0부터 k30_iPerson보다 작을때까지 1씩 증가시키면서 수행한다.
			...
			k30_ArrayOneRec.add(new P10OneRec(k30_i + 1, k30_name, k30_kor, k30_eng, k30_mat));//ArrayList에 P9OneRec 함수를 통해서 만들어진 값을 저장한다.
		}
	}
}
